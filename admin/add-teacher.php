    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query->rowCount() > 0) {
            ...
            if (!in_array($extension, $allowed_extensions)) {
                ...
                $sql = "insert into tblteacher(Name,Picture,Email,MobileNumber,Qualifications,Address,TeacherSub,JoiningDate,RegDate,teachingExp,description)values(:tname,:tpics,:email,:mobilenumber,:qualifications,:address,:tsubjects,:joiningdate,:dateofbirth,:teachingexp,:description)";
                            ...
                            <div class="card">
                                ...
                                <form name="" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-12">
                                                <div class="form-group"><label for="city" class=" form-control-label">Date Of Birth</label><input type="date" name="dateofbirth" id="birthofbirth" value="" class="form-control" required="true"></div>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col-12">

                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Manage Teacher</strong>
                                </div>
                                <div class="card-body">
                                            ...
                                            foreach ($results as $row) {               ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        echo $age; ?></td>
                                                    <td><a href="edit-teacher-detail.php?tid=<?php echo htmlentities($row->ID); ?>" class="btn btn-primary" style="background-color: #03C04A;">Edit</a>

        ...
        <section class="py-5">
            <div class="container px-5 my-5">
                <form method="post" action="search-result.php">
                    <aside class="bg-success rounded-3 p-3 p-sm-4 mt-4">
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6">
                        <div class="text-center">
                            <h2 class="fw-bolder fs-4">Listed Teachers</h2>
                            <hr color="red" />
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-3 mb-4">
                                <div class="card h-100 shadow border-0">
                                    ...
                                    <div class="card-body p-3">
                                        <div class="badge bg-success bg-gradient rounded-pill mb-2"><?php echo htmlentities($row->TeacherSub); ?></div>
                                        <a class="text-decoration-none link-dark stretched-link" href="teacher-details.php?tid=<?php echo $row->ID; ?>" target="_blank">
                                            <h6 class="card-title mb-2"><?php echo htmlentities($row->Name); ?></h6>
                                        </a>

...
<body class="bg-dark" style=" background-image: url('images/cool-background.png');">
    <div class="sufee-login d-flex align-content-center flex-wrap" style="background-color: #ffffff; padding: 20px;">
        <div class="container" style="background-color: #1b1b32 #f5f6f7; ">
            <div class="login-content">
                ...
                <div class="login-form">
                    <form action="" method="post" name="login">
                        ...
                        <br>
                        <div class="checkbox" style="display: flex; justify-content: space-between;margin-top:2px;">
                            <label>
                                <a href="../index.php">Back to Home!!</a>
                            </label>
                            <label>
                                <a href="index.php" style="margin-left: auto;">Already Registered? Login Here</a>
                            </label>
                        </div>
                    </form>
                </div>

...
if (strlen($_SESSION['trmsuid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $status = $_POST['status'];
        $sql = "update tblteacher set Name=:tname,Email=:email,MobileNumber=:mobilenumber,Qualifications=:qualifications,Address=:address,TeacherSub= :tsubjects,JoiningDate=:joiningdate, RegDate=:dateofbirth, description=:description,teachingExp=:teachexp,isPublic=:status where ID=:eid";
        ...
        $query->bindParam(':dateofbirth', $date, PDO::PARAM_STR);
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $row) {               ?>
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-12">
                                                        <div class="form-group"><label for="city" class=" form-control-label">Date Of Birth</label><input type="date" name="dateofbirth" id="dateofbirth" value="<?php echo $row->dateofbirth; ?>" class="form-control" required="true"></div>
                                                    </div>
                                                </div>
                                    </div>
